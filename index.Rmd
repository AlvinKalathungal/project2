...
sumATKPerSec
```
Python: I didn't think anyway to be creative for the python section of this project so I decided to replicate what was done in the homework. I was interested in seeing attack per second reflected the smite characters. I grabbed that smite$attackPersecond from python. Moved it to python. Python calculated the values and I grabbed them in R and displayed them in there own variable. 
